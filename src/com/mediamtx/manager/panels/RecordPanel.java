...
public class RecordPanel extends JPanel {
    ...
    public RecordPanel(MediaMTXService service) {
        ...
        JLabel title = new JLabel("\uD83C\uDFA4  Configura\u00e7\u00f5es de Grava\u00e7\u00e3o");
        ...
        form.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(Theme.BORDER_MED, 1, true),
        ...
        chkRecord = new JCheckBox("Ativar grava\u00e7\u00e3o autom\u00e1tica de streams");
        chkRecord.setFont(Theme.FONT_BOLD);
        chkRecord.setForeground(Theme.TEXT);
        chkRecord.setOpaque(false);
        g.gridx = 0; g.gridy = 0; g.gridwidth = 3;
        form.add(chkRecord, g);
        g.gridwidth = 1;

        g.gridx = 0; g.gridy = 1; form.add(lbl("Diret\u00f3rio de sa\u00edda:"), g);
        txtPath = field("./recordings/%path/%Y-%m-%d_%H-%M-%S-%f", 36);
        g.gridx = 1; form.add(txtPath, g);
        JButton btnBrowse = new JButton("...");
        btnBrowse.setFont(Theme.FONT_BOLD);
        btnBrowse.setBackground(Theme.BG);
        btnBrowse.setForeground(Theme.ACCENT);
        ...
        cmbFormat = new JComboBox<>(new String[]{"fmp4", "mpegts"});
        cmbFormat.setFont(Theme.FONT_MEDIUM);
        g.gridx = 1; form.add(cmbFormat, g);

        g.gridx = 0; g.gridy = 3; form.add(lbl("Dura\u00e7\u00e3o do segmento:"), g);
        txtSegment = field("1h", 10);
        g.gridx = 1; form.add(txtSegment, g);

        g.gridx = 0; g.gridy = 4; form.add(lbl("Deletar ap\u00f3s:"), g);
        txtDelete = field("24h", 10);
        g.gridx = 1; form.add(txtDelete, g);

        JLabel vars = new JLabel("<html><i><small>Vari\u00e1veis: %path=nome do stream &#124; %Y/%m/%d=data &#124; %H/%M/%S=hora</small></i></html>");
        vars.setFont(Theme.FONT_SMALL);
        vars.setForeground(Theme.TEXT_MUTED);
        g.gridx = 0; g.gridy = 5; g.gridwidth = 3;
        form.add(vars, g);

        JButton btnApply = Theme.primaryButton("\uD83D\uDCCB  Gerar trecho YAML");
        btnApply.setPreferredSize(new Dimension(210, 36));
    ...
    private JTextField field(String v, int c) {
        JTextField f = new JTextField(v, c);
